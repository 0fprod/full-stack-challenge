...
export class UpdateMonsterDTO {
  @ApiProperty({ example: '1234', description: 'Monsters id' })
  @IsString()
  @IsNotEmpty()
  id: string;

  @ApiProperty({ example: 'Mr', description: 'Monsters title', required: false })
  @IsOptional()
  @IsString()
  title: string;

  @ApiProperty({ example: 'Wise', description: 'Monsters name', required: false })
  @IsOptional()
  @IsString()
  firstName: string;
